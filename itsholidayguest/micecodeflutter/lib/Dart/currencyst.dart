...
class CurrencySTT extends StatelessWidget {
  @override
...
class CurrencyST extends StatefulWidget {
  @override
  State createState() => MyCurrencyST();
}

class MyCurrencyST extends State<CurrencyST> {
                                    ...
                                    child:  DropdownButton(
                                      ...
                                      items: sendfull
                                        ...
                                        return DropdownMenuItem<String>(
                                            value: itemnames,
                                            child: Text(itemnames, textAlign: TextAlign.center));
                                      }).toList(),
...
/*  Future<void> currency() async {
    ...
    Fluttertoast.showToast(
        msg: "Currency URL is : " + url.toString(),
        toastLength: Toast.LENGTH_SHORT,
        gravity: ToastGravity.BOTTOM,
