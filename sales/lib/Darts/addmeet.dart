...
import 'package:salescrm/Darts/addnewmeet.dart';
import 'package:salescrm/Darts/meeting.dart';
...
import '../Models/addmeetmodel.dart';
import '../Models/allmeetname.dart';
import '../Providers/callprovider.dart';
import '../Providers/namemeetprovider.dart';
...
class AddMeetST extends StatefulWidget {

  @override
  State createState() => new MyMeetCallST();
}

class MyMeetCallST extends State<AddMeetST> {

  late SharedPreferences prefs,preflog_in_out;

  List<ResultsNameMeet>? allnamemodels;
  late ResultsNameMeet selectedNames;
  ...
  var activityarr1=["Meeting","Agent"];

  var businessarr=["Agent","Call"];
  ...
  String? subValidate(String? value) {
    if (value == null || value.isEmpty)
                  ...
                  child: SingleChildScrollView(
                    child: Column(children: [
                                    ...
                                    child: Consumer<CallProvider>(
                                        builder: (context, provider, child){
                                          ...
                                          return DropdownButton(
                                            ...
                                            items: activityarr1.map((String itemnames) {
                                            ...
                                            onChanged: (String? value) {
                                              CallProvider.activitytpye1=value!;

                                              provider.selectActivity1();

                                            },
                                            value: CallProvider.activitytpye1,
                                          );
                                        }
                                    )
                      ...
                      Row(children: [
                        ...
                        InkWell(onTap: (){
                          Navigator.of(context).push(MaterialPageRoute(builder: (context)=>AddNewMeetST()),).then((value) =>{ getUpdate()});
                          ...
                          children: [
                            ...
                            FutureBuilder(
                                ...
                                builder:(context,  snapshot) {
                                  if (snapshot.hasData) {
                                    allnamemodels = snapshot.data as List<ResultsNameMeet>?;
                              ...
                              child: Container(
                                ...
                                child: Row(children: [
                                  ...
                                  Container(
                                    ...
                                    child: Image.asset("image/location.png",height: 20, width: 22.5,),
                                  ),
  ...
  void validatdation() {
   ...
   //   Navigator.pop(context);
     // getUpdateProfile();
      ...
      print("Error");
      Fluttertoast.showToast(
          msg: "Enter Your Current Location",
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM,
          timeInSecForIosWeb: 4,
          backgroundColor: Colors.black,
  ...
  Future<List <ResultsAddMeet>> getAddMeet() async {
    List<ResultsAddMeet> logindata = [];

    String newurl = AppNetworkConstants.ADDMEET;

  //  String newurl = "https://inboundcrm.in/travcrm-dev_2.2/Api/App/nikhil/json_addmeeting.php";

    print("Add Meet Url is :"+newurl);
    ...
    print("Subject are : " + subController.text.trim());
    print("phone are : " + m_number);
    print("location are : " + address);

    if(res.statusCode==200) {
        var datas = jsonDecode(res.body)['results'] as List;

        logindata = datas.map((data) => ResultsAddMeet.fromJson(data)).toList();
  ...
  Future<List <ResultsNameMeet>> getAllNames() async{

    String newurl=AppNetworkConstants.ALLMEETNAMES;

 //   String newurl= "https://inboundcrm.in/travcrm-dev_2.2/Api/App/nikhil/json_showmeeting.php";
    ...
    List<ResultsNameMeet> agentdata = datas.map((data) => ResultsNameMeet.fromJson(data)).toList();
  ...
  getAddress(lat,lon) async {
   ...
   /* for(int i=0; i<placemarks.length; i++){
      print("Current Address is :  "+ placemarks[0].street.toString()+" "+placemarks[0].subLocality.toString()
          +" "+placemarks[0].locality.toString()+" "+placemarks[0].postalCode.toString()
          +" "+placemarks[0].country.toString());
    }*/
  }
  ...
  Widget getAllNameWidget(){
    ...
    return  ChangeNotifierProvider(
        create: (context) => NameMeetProvider(),

        child: Consumer<NameMeetProvider>(
            builder: (context, provider, child){
                        ...
                        child: ListView.builder(
                          //  padding: EdgeInsets.only(top: 15),
                            ...
                            itemBuilder: (context,index){
                              ResultsNameMeet itemslists =allnamemodels![index];
                                                      ...
                                                      child:DropdownButtonHideUnderline(
                                                        child: ButtonTheme(
                                                          ...
                                                          child: DropdownButton(
                                                            ...
                                                            items: allnamemodels!.map((ResultsNameMeet allname) {
                                                              return DropdownMenuItem<ResultsNameMeet>(
                                                                  value: allname,
                                                                  child: Text( allname.name.toString(),textAlign: TextAlign.center,style:
                                                                  TextStyle(color: Colors.black54,fontSize: 12,fontFamily: 'BebesNeue',fontWeight: FontWeight.w700),
                                                                  )
                                                              );
                                                            }).toList(),


                                                            onChanged: (ResultsNameMeet? user) {

                                                              mypos=allnamemodels!.indexOf(user!);
                                                              selectedNames = user;
                                                              m_cname=user.name.toString();
                                                              m_cperson=user.contactPerson.toString();
                                                              m_number=user.contactNo.toString();

                                                              provider.selectUser(m_cperson,m_cname,m_number,selectedNames,mypos);
                                                  ...
                                                  children: [
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Column(children: [
                                                        ...
                                                        Container(
                                                          margin: EdgeInsets.only(left: 15,right: 55, top: 5),
                                                          child:  Text("Contact Person",
                                                            style: TextStyle(color: Colors.blue,fontSize: 10,fontFamily: 'BebesNeue',fontWeight: FontWeight.w700),),
                                                        ),
                                                        ...
                                                        /* Container(
                                                          width: 110,
                                                          height: 30,
                                                          margin: EdgeInsets.only(left: 15, right: 10,bottom: 7.5),
                                                          child: TextFormField(
                                                            // textAlign: TextAlign.center,
                                                    ...
                                                    Container(
                                                      child: Column(children: [
                                                        Container(
                                                          margin: EdgeInsets.only(left: 20,right: 55, top: 5),
                                                          child:  Text("Contact Number",
                                                            style: TextStyle(color: Colors.blue,fontSize: 10,fontFamily: 'BebesNeue',fontWeight: FontWeight.w700),),
                                                        ),
                                                    ...
                                                    InkWell(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Image.asset("image/callblue.png",height: 20, width: 22,),
                                                      ),
                                                    ),
                                                    ...
                                                    InkWell(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Image.asset("image/whatsapp.png",height: 22, width: 24.5,),
                                                      ),
                                                    ),
