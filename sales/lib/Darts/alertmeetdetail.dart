...
class AlertMeetDetailST extends StatefulWidget {
  // ItemDetail({required this.itemlist});

  @override
  State createState() => new MyAlertMeetDetailST();
}

class MyAlertMeetDetailST extends State<AlertMeetDetailST> {

  List<ResultAlertMeetDetail>? alertmeetdetailmodels;
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Text("Alert Meeting Details",
            ...
            child: Column(
             ...
             /* Container(
              ...
              // Call Api
                ...
                FutureBuilder(
                    future: getAlertsMeetDetail(),
                    builder:(context,  snapshot) {

                      if(snapshot.hasData) {

                        alertmeetdetailmodels = snapshot.data as List<ResultAlertMeetDetail>?;

                        contactPerson = alertmeetdetailmodels![0].contactPerson.toString();
                        company = alertmeetdetailmodels![0].company.toString();
                        subject = alertmeetdetailmodels![0].subject.toString();
                        product = alertmeetdetailmodels![0].product.toString();
                        Date = alertmeetdetailmodels![0].date.toString();
                        time = alertmeetdetailmodels![0].time.toString();
                        callnumber = alertmeetdetailmodels![0].number.toString();
                        whatsappnumber = alertmeetdetailmodels![0].number.toString();
  ...
  Future<List <ResultAlertMeetDetail>> getAlertsMeetDetail() async{

  //  String newurl = "https://inboundcrm.in/travcrm-dev_2.2/Api/App/nikhil/json_meetdetail.php?id="+id;

    String newurl=AppNetworkConstants.ALERTSMEETDETAIL+"?id="+id;

    print("Alerts Meet Detail url is : "+newurl);
    ...
    print("Alerts Meet Detail response is : "+res.body);

    var datas= jsonDecode(res.body)['result'] as List;

    List<ResultAlertMeetDetail> dashdata = datas.map((data) => ResultAlertMeetDetail.fromJson(data)).toList();
