...
class AddNewST extends StatefulWidget {

  @override
  State createState() => new MyAddNewST();
}

class MyAddNewST extends State<AddNewST> {
  ...
  Future<List <ResultsAddNewCall>> getAddNewCall() async {

    String newurl = AppNetworkConstants.ADDNEWCALL;

    //  String newurl = "https://inboundcrm.in/travcrm-dev_2.2/Api/App/nikhil/nikhil_Test_addnewcall.php";

    List<ResultsAddNewCall> imgdata=[];
    print("AddNewCall URL : " + newurl);
    ...
    */
    ...
    if(res.statusCode == 200){
      ...
      print("Response of AddNewCall Images are :  ${res.statusCode}");
    ...
    //  Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=> AddCallST()));
    }else{
      Fluttertoast.showToast(
