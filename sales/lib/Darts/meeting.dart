...
import 'package:salescrm/Models/startmeetmodel.dart';
...
class MeetingST extends StatefulWidget {
  // ItemDetail({required this.itemlist});

  @override
  State createState() => new MyMeetingST();
}

class MyMeetingST extends State<MeetingST> {
            ...
            child: Column(children: [
              ...
              FutureBuilder(
                  ...
                  builder:(context, snapshot) {
                    ...
                    if(snapshot.hasData) {
                      meetmodel= snapshot.data as List<ResultsMeeting>;
          ...
          child: Column(
            children: [
              ...
              Expanded(child:  ListView.builder(
                  ...
                  itemCount: meetmodel!.length,
                  itemBuilder: (context,index){
                    ResultsMeeting itemslists = meetmodel![index];
                      ...
                      child: Column(children: [
                        ...
                        Row(children: [
                          ...
                          Container(
                            ...
                            child: Center(
                              child: Text(itemslists.date.toString()+"  "+itemslists.starttime.toString(),
                                style: TextStyle(
                                    color: Colors.grey,
                                    fontSize: 11,
                                    fontFamily: 'BebesNeue',
                        ...
                        Row(children: [
                          ...
                          InkWell(
                            onTap:(){
                              myid=itemslists.id.toString();
                              print("Id is : "+myid);

                              if (itemslists.status == "Scheduled") {
                                startScheduledDialog(context);
                              }
                              else if (itemslists.status == "Held") {
                                startHeldDialog(context);
                              }
                              else if (itemslists.status == "Canceled") {
                               startCancelDialog(context);
                              }
                        ...
                        Row(children: [
                          ...
                          Container(
                            ...
                            width: 65,
                            child:  Text(itemslists.meetingAgenda.toString(),
                          ...
                          Visibility(
                            ...
                            child: InkWell(
                              onTap:(){
                                 callnumber=itemslists.phoneNo.toString();
                        ...
                        InkWell(
                          onTap: (){
                            pickupAddress=itemslists.location.toString();
                          ...
                          child: Row(children: [
                            ...
                            Container(
                              width: 240,
                              margin: EdgeInsets.only(left: 2.5, top: 10,right: 10),

                              child:  Text(itemslists.location.toString(),
                                  style: TextStyle(color: Colors.grey,fontSize: 10,fontFamily: 'BebesNeue',fontWeight: FontWeight.w700),maxLines: 1,overflow: TextOverflow.ellipsis),
                            ),
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Image.asset("image/" +meetplane, height: 16, width: 16,),
                                ),
                              ),
  ...
  startScheduledDialog(BuildContext context) {
    return showDialog(
        context: context,
        builder: (context) {
          return StatefulBuilder(
                            ...
                            if(location==""){
                              ...
                              Fluttertoast.showToast(
                                ...
                                newsetState(() {
                                  setState(() {
                                    Navigator.pop(context);
                                    Navigator.of(context).push(MaterialPageRoute(builder: (context)=>CurrentLocation(newaddress: location)));
                                  });
                              });
                           //
                          //
  ...
  startHeldDialog(BuildContext context) {
    return showDialog(
        context: context,
        builder: (context) {
          return StatefulBuilder(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: (){
                            ...
                            //  getStartMeet();
                              Fluttertoast.showToast(
                                  msg: "it's still a work in progress",
                                  toastLength: Toast.LENGTH_SHORT,
                                  gravity: ToastGravity.BOTTOM,
                                  timeInSecForIosWeb: 4,
                                  backgroundColor: Colors.black,
  ...
  startCancelDialog(BuildContext context) {
    return showDialog(
        context: context,
        builder: (context) {
          return StatefulBuilder(
  ...
  Future<List <ResultsMeeting>> getMeet() async{

  //  String newurl="https://inboundcrm.in/travcrm-dev_2.2/Api/App/nikhil/json_meeting_api.php";


    //  String newurl="https://inboundcrm.in/travcrm-dev_2.2/Api/App/nikhil/json_meeting_api.php?followupdate="+fromtime+"&status="+CallProvider.typevalue;

    String newurl=AppNetworkConstants.MEETINGS +"?date="+fromtime+"&status="+CallProvider.typevalue;

    print("Meeting url is : "+newurl);
    ...
    print("Meeting response is : "+res.body);

    var datas= jsonDecode(res.body)['results'] as List;

    List<ResultsMeeting> dashdata = datas.map((data) => ResultsMeeting.fromJson(data)).toList();

    if(dashdata.length==0) {
      Fluttertoast.showToast(
          msg: "No Meeting for Today",
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM,
          timeInSecForIosWeb: 3,
          backgroundColor: Colors.black,
  ...
  Future<List <ResultsStartMeet>> getStartMeet() async {
    List<ResultsStartMeet> logindata = [];

      String newurl = AppNetworkConstants.STARTMEETING+"?id="+myid;

 //   String newurl = "https://inboundcrm.in/travcrm-dev_2.2/Api/App/nikhil/json_startMeeting.php?id="+myid;
    ...
    print("Add Meet Response is :"+res.body);

    print("status are : " + status);
    ...
    logindata = datas.map((data) => ResultsStartMeet.fromJson(data)).toList();
