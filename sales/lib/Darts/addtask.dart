...
import 'package:salescrm/Darts/addnewtask.dart';
...
import '../Models/alltaskname.dart';
import '../Providers/callprovider.dart';
import '../Providers/nametaskprovider.dart';
import '../main.dart';
import 'addnew.dart';
...
class AddTaskST extends StatefulWidget {

  @override
  State createState() => new MyTaskCallST();
}

class MyTaskCallST extends State<AddTaskST> {

  late SharedPreferences prefs,preflog_in_out;

  List<ResultsTaskName>? allnamemodels;
  late ResultsTaskName selectedNames;
                  ...
                  child: SingleChildScrollView(
                    child: Column(children: [
                                    ...
                                    child: Consumer<CallProvider>(
                                        builder: (context, provider, child){
                                          ...
                                          return DropdownButton(
                                            ...
                                            items: activityarr2.map((String itemnames) {
                                            ...
                                            onChanged: (String? value) {
                                              CallProvider.activitytpye2=value!;

                                              provider.selectActivity2();

                                            },
                                            value: CallProvider.activitytpye2,
                                          );
                                        }
                                    )
                      ...
                      Row(children: [
                        ...
                        InkWell(onTap: (){
                          Navigator.of(context).push(MaterialPageRoute(builder: (context)=>AddNewTaskST()),).then((value) =>{ getUpdate()});
                            ...
                            FutureBuilder(
                                ...
                                builder:(context,  snapshot) {
                                  ...
                                  if(snapshot.hasData) {
                                    ...
                                    allnamemodels = snapshot.data as List<ResultsTaskName>?;
                                          ...
                                          child: Consumer<CallProvider>(
                                              builder: (context, provider, child){
                                                ...
                                                return DropdownButton(
                                                  ...
                                                  items: priorityarr.map((String itemnames) {
                                                    return DropdownMenuItem<String>(
                                                  ...
                                                  onChanged: (String? value) {
                                                    CallProvider.prioritytype=value!;

                                                    provider.selectPriority();

                                                  },
                                                  value: CallProvider.prioritytype,
                                                );
                                              }
                                          )
  ...
  Future<List <ResultsAddTask>> getAddTask() async {
    List<ResultsAddTask> logindata = [];

      String newurl = AppNetworkConstants.ADDTASK;

  //  String newurl = "https://inboundcrm.in/travcrm-dev_2.2/Api/App/nikhil/json_addtask.php";

    print("Add Task Url is :"+newurl);
    ...
    var res = await http.post(Uri.parse(newurl),
        ...
        body: ({
          ...
          'nexttime': fromtime,
          'priority': CallProvider.priorityvalue,
    ...
    if(res.statusCode==200) {
      ...
      logindata = datas.map((data) => ResultsAddTask.fromJson(data)).toList();

   //   Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=> TaskST()));
  ...
  Future<List <ResultsTaskName>> getAllNames() async{

    String newurl=AppNetworkConstants.ALLTASKNAMES;

  //  String newurl= "https://inboundcrm.in/travcrm-dev_2.2/Api/App/nikhil/json_showtask.php";
    ...
    List<ResultsTaskName> agentdata = datas.map((data) => ResultsTaskName.fromJson(data)).toList();
  ...
  Widget getAllNameWidget(){
    ...
    return  ChangeNotifierProvider(
        create: (context) => NameTaskProvider(),

        child: Consumer<NameTaskProvider>(
            builder: (context, provider, child){
                        ...
                        child: ListView.builder(
                          //  padding: EdgeInsets.only(top: 15),
                            ...
                            itemBuilder: (context,index){
                              ResultsTaskName itemslists =allnamemodels![index];
