...
class B2BST extends StatefulWidget {
  // ItemDetail({required this.itemlist});

  @override
  State createState() => new MyB2BST();
}

class MyB2BST extends State<B2BST> {

  late SharedPreferences prefs, preflog_in_out;

  GlobalKey<ScaffoldState> _drawerkey = GlobalKey<ScaffoldState>();

  List<ResultsB2B>? b2bmodel;
  ...
  late ArticlesBussinessType selectedbustype;
  String m_bustypename="";
  String m_bustypeid="37";
  int mybustypepos=0;
                      ...
                      FutureBuilder(
                          ...
                          builder:(context,  snapshot) {
                            ...
                            if(snapshot.hasData) {
                              ...
                              bustypemodel= snapshot.data as List<ArticlesBussinessType>?;

                              selectedbustype = bustypemodel![mybustypepos];
                              print("Position : "+mybustypepos.toString());
                                        ...
                                        child: Consumer<CallProvider>(
                                            builder: (context, provider, child) {
                                              return DropdownButton(
                                                ...
                                                items: bustypemodel!.map((ArticlesBussinessType user) {
                                                  return DropdownMenuItem<ArticlesBussinessType>(
                                                      value: user,
                                                      child: Text( user.name.toString(),textAlign: TextAlign.center,style: TextStyle(color: Colors.white,fontSize: 13,
                                                          fontFamily: 'BebesNeue',
                                                          fontWeight: FontWeight.w700),)
                                                  );
                                                }).toList(),
                                                ...
                                                onChanged: (ArticlesBussinessType? user) {

                                                  mybustypepos=bustypemodel!.indexOf(user!);
                                                  selectedbustype = user!;
                                                  m_bustypename=user!.name.toString();
                                                  m_bustypeid=user!.id.toString();

                                                  //  PickersResultTargetProvider.username=user!.username.toString();
                                                  provider.selectBusType(m_bustypename,m_bustypeid,selectedbustype,mybustypepos);
                      ...
                      child:  FutureBuilder(
                          ...
                          builder:(context, snapshot) {
                            ...
                            if(snapshot.hasData) {
                              ...
                              b2bmodel= snapshot.data as List<ResultsB2B>?;
          ...
          child: Column(
            children: [
              ...
              Expanded(child: ListView.builder(
                  ...
                  itemCount: b2bmodel!.length,
                  itemBuilder: (context, index) {
                    ResultsB2B itemslists = b2bmodel![index];

                    if(itemslists.companyPhone==""){
                      isCall=false;
                      isWhatsapp=false;
                    }else{
                      isCall=true;
                      ...
                      child: Column(children: [
                        ...
                        Row(children: [
                          ...
                          Container(
                            ...
                            width: 100,
                            child: Text(itemslists.companyEmail.toString(),
                              style: TextStyle(color: Colors.grey,
                                  fontSize: 9,
                                  fontFamily: 'BebesNeue',
                                  fontWeight: FontWeight.w700),maxLines: 1,),
                        ...
                        Row(children: [
                          ...
                          Container(
                            ...
                            width: 60,
                            child: Center(
                              child: Text(itemslists.companyPhone.toString(),
                                  style: TextStyle(color: Colors.grey,
                                      fontSize: 9,
                                      fontFamily: 'BebesNeue',
                                      fontWeight: FontWeight.w700),maxLines: 1),
                          ...
                          Visibility(
                            ...
                            child: InkWell(
                              onTap:(){
                                callnumber=itemslists.companyPhone.toString();
                            ...
                            child: InkWell(
                              onTap:(){
                               // whatsappnumber="+91-9910924485";
                                 whatsappnumber=itemslists.companyPhone.toString();
                          ...
                          Container(width: 30,height: 1,color: Colors.grey,margin: EdgeInsets.only(top: 5),),
                          ...
                          Container(width: 30,height: 1,color: Colors.grey,margin: EdgeInsets.only(left:2.5,top: 5,right: 10)),
  ...
  Future<List <ResultsB2B>> getB2B() async{

 //   String newurl="https://inboundcrm.in/travcrm-dev_2.2/Api/App/SALES/json_b2b.php?userid=37&buisnessid=82";

      String newurl=AppNetworkConstants.B2B+"?userid="+m_userid+"&buisnessid="+m_bustypeid;
    ...
    List<ResultsB2B> dashdata = datas.map((data) => ResultsB2B.fromJson(data)).toList();
  ...
  Future<List <ArticlesBussinessType>> getBusType() async{

 //   String newurl="https://inboundcrm.in/travcrm-dev_2.2/Api/App/SALES/json_buisnesstype.php";

      String newurl=AppNetworkConstants.BUSTYPE;

    print("Buss Type Url is : "+ newurl.toString());
    ...
    print("Bus Type Response is : "+ res.body);

    var datas= jsonDecode(res.body)['articles'] as List;

    List<ArticlesBussinessType> agentdata = datas.map((data) => ArticlesBussinessType.fromJson(data)).toList();
