...
import '../Models/addnewtaskmodel.dart';
import '../Providers/callprovider.dart';
import 'calltodaydata.dart';
import 'data.dart';
import 'items.dart';

class AddNewTaskST extends StatefulWidget {

  @override
  State createState() => new MyAddNewTaskST();
}

class MyAddNewTaskST extends State<AddNewTaskST> {
  ...
  Future<List <ResultsAddNewTask>> getAddNewTask() async {

    String newurl = AppNetworkConstants.ADDNEWTASK;

  //  String newurl = "https://inboundcrm.in/travcrm-dev_2.2/Api/App/nikhil/json_addnewtask.php";

    List<ResultsAddNewTask> imgdata=[];
    print("AddNewTask URL : " + newurl);
