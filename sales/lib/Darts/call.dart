...
class CallST extends StatefulWidget {
  // ItemDetail({required this.itemlist});

  @override
  State createState() => new MyCallST();
}

class MyCallST extends State<CallST> {
            ...
            child: Column(children: [
              ...
              FutureBuilder(
                  ...
                  builder:(context, snapshot) {
                    ...
                    if(snapshot.hasData) {
                      callmodel= snapshot.data as List<ResultsCall>;
            ...
            children: [
              ...
              Expanded(child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ResultsCall itemslists = callmodel![index];
                        ...
                        Row(children: [
                          ...
                          Container(
                            margin: EdgeInsets.only(
                                left: 10, top: 10),
                            width: 150,
                            child: Text(itemslists.companyname.toString(),
                        ...
                        Row(children: [
                          ...
                          Container(
                            margin: EdgeInsets.only(
                                left: 2.5, top: 5),
                            width: 65,
                            child: Text(itemslists.calltype.toString(),
                              style: TextStyle(color: Colors.grey,
                                  fontSize: 10,
                                  fontFamily: 'BebesNeue',
                                  fontWeight: FontWeight.w700),),
                            ...
                            children: [
                              ...
                              InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: Image.asset("image/" + callplane, height: 16, width: 16,),
                                  ),
                              ),
  ...
  //  String newurl= "https://inboundcrm.in/travcrm-dev_2.2/Api/App/nikhil/json_call.php";/*?followupdate=01-06-2023&status=2*/
    ...
    String newurl=AppNetworkConstants.CALLS +"?date="+fromtime+"&status="+CallProvider.typevalue;
