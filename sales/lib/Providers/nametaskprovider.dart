...
class NameTaskProvider with ChangeNotifier {

  List<ResultsTaskName>? allnamesmodels;
  static late ResultsTaskName selectedUser;
  static int pos = 0;
  static String id="0";
  ...
  selectUser(String cnumber, String cname, String cperson, ResultsTaskName selectuser,int position){
    contactno=cnumber;
  ...
  selectUserSearch(String cnumber, String cname, String cperson, ResultsTaskName selectuser,int position){
    contactno=cnumber;
    contactperson=cperson;
    selectedUser=selectuser;
    companyname=cname;
