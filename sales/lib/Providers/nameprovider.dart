...
class NameProvider with ChangeNotifier {
  ...
  List<ResultsAllName>? allnamesmodels;
  static late ResultsAllName selectedUser;
  static int pos = 0;
  static String id="0";
  ...
  static String dropdownvalueuser="Select Users";  // for month name
   ...
   selectUser(String cnumber,String cname, String cperson, ResultsAllName selectuser,int position){
    contactno=cnumber;
  ...
  selectUserSearch(String cnumber, String cname, String cperson, ResultsAllName selectuser,int position){
    contactno=cnumber;
    contactperson=cperson;
    selectedUser=selectuser;
    companyname=cname;
