...
import '../Models/adhaarimgmodel.dart';
import '../Models/feedimgmodel.dart';
import '../Utils/Apis.dart';



class AadharSL extends StatelessWidget {
  @override
...
class Aadhar extends StatefulWidget {
  ...
  @override
  State createState() => MyAadhar();
}

class MyAadhar extends State<Aadhar> {
      ...
      body:Container(
        ...
        child: Column(
         ...
         children: [
           ...
           Container(
             child: Image.asset("image/adharmice.png",height: 100, width: 100,),
           ),
  ...
  Future<List <ResultsAdhaar>> getAdhaarImg() async {

    String newurl = TravApis.ADHAARIMG;

    List<ResultsAdhaar> imgdata=[];
    print("Adhaar Image URL : " + newurl);
