...
import 'package:driverapp/Models/EndActModel.dart';
import 'package:driverapp/Models/RejectedListModel.dart';
import 'package:driverapp/Models/StartactivityModel.dart';
...
class MyPendingDuties extends State<PendingDuties> {
  ...
  String? startValidate(String? value) {
    if (value == null || value.isEmpty)
      return 'Enter Start Activity Time';
    else
      startup = value;
    print("Start Activity Time is : " + startup);
    return null;
  }

  String? endValidate(String? value) {
    if (value == null || value.isEmpty)
      return 'Enter End Activity Time';
    else
      endup = value;
    print("End Activity Time is : " + endup);
    return null;
  }
                ...
                child: Column(children: [
                  ...
                  Container(
                    ...
                    child: Container(
                      ...
                      child: Center(child:Text("PENDING DUTIES", style: TextStyle(color: Colors.black54, fontSize: 15, fontFamily: 'BebesNeue',
                          fontWeight: FontWeight.w700),),),
                    ),
                  ),
  ...
  Future<List<ResultsStartAct>> getStartActivity() async {

   // String newurl = "https://inboundcrm.in/travcrm-dev_2.2/driverapp/json_startTrip.php?driverId=45&roleId=03&queryId=1403&transferQuotId=820&quotationId=1665&startreading=200";

  //  String newurl = AppNetworkConstants.STARTACTIVITY + "driverId=" +UserId!+ "&roleId=" +roleId!+ "&queryId=" +queryId!+ "&transferQuotId=" +transferQuoteId!+ "&quotationId=" +quationId!+"&startreading="+m_startcontroller.text.trim();

    String newurl = AppNetworkConstants.STARTACTIVITY + "driverId=" +UserId!+ "&roleId=" +roleId!+ "&queryId=" +queryId!+ "&transferQuotId=" +transferQuoteId!+ "&quotationId=" +quationId!+"&startreading=10";

    print("START ACTIVITY URL : "+newurl);
    ...
    print("Start Activity Response : "+res.body);
    ...
    List<ResultsStartAct> starttripdata = datas.map((data) =>
        ResultsStartAct.fromJson(data)).toList();

    String Message = starttripdata[0].message!;

    print("StartTrip Message is : $Message");
  ...
  Future<List<AcceptBookingEnd>> getEndActivity() async {


  //  String newurl = AppNetworkConstants.ENDACTIVITY + "driverId=" +UserId!+ "&roleId=" +roleId!+ "&queryId=" +queryId!+ "&transferQuotId=" +transferQuoteId!+ "&quotationId=" +quationId!+ "&endReading=" +m_endcontroller.text.trim();

    String newurl = AppNetworkConstants.ENDACTIVITY + "driverId=" +UserId!+ "&roleId=" +roleId!+ "&queryId=" +queryId!+ "&transferQuotId=" +transferQuoteId!+ "&quotationId=" +quationId!+ "&endReading=20";

    print("END ACTIVITY URL : "+newurl);
    ...
    print("End Activity Response : "+res.body);
    ...
    List<AcceptBookingEnd> endactdata = datas.map((data) =>
        AcceptBookingEnd.fromJson(data)).toList();

    String Message = endactdata[0].message!;

    print("End Activity Message is : $Message");
              ...
              actions: [
                ...
                Column(children: [
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Text("Enter Start Activity Time",
              ...
              actions: [
                ...
                Column(children: [
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.only(left: 5,right: 5,top: 15),
                    child: Center(
                      child: Text("Enter End Activity Time",
                          // textAlign: TextAlign.left,
                          style: TextStyle(color: Colors.black,
                            fontSize: 14,
                            fontFamily: 'BebesNeue',
